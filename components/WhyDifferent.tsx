...
export default function WhyDifferent() {
  return (
    <section className="py-16 lg:py-24 bg-white px-6 md:px-12" style={{}}>
      <div className="container max-w-6xl  mx-auto pt-12 md:pt-24 pb-12" style={{ margin: "auto" }}>
        <h2 className="text-3xl md:text-[40px] lg:text-[46px] font-[800] text-[#1a202c] text-center mb-[40px] md:mb-[60px] tracking-tight leading-tight">
        ...
        <div className="grid lg:grid-cols-12 items-start mb-16 gap-[50px] mx-auto" style={{ width: "100%", padding: "50px  0px" }}>
          ...
          >
            <div className="w-full text-center lg:text-center">
              <div className="text-[30px] text-white mb-2 font-bold tracking-wide">Spreads from</div>
              ...
              <div className="text-[32px] font-bold tracking-wide text-center" style={{ color: '#ffffff' }}>pips</div>
            </div>
          </div>

          {/* Right - Features Grid */}
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-12" style={{ padding: "0px 20px" }}>
            {/* Cross-Asset Trading */}
            <div className="flex flex-col">
              ...
              <h3 className="text-[20px] font-bold text-[#1a202c] mb-3 leading-[1.3]">
