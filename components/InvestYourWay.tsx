      ...
      <div className="container max-w-6xl px-6" style={{ margin: 'auto', padding: '50px 20px' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-500 mb-6 leading-relaxed" style={{ color: "rgba(135, 145, 156, 1)", lineHeight: "150%" }}>
              Ouryx is built for traders who prioritise conditions over marketing promises.
            </p>
            <br></br>
            <p className="text-gray-500 mb-8 leading-relaxed" style={{ color: "rgba(135, 145, 156, 1)" }}>
            ...
            <br></br>
            {/* Category Tabs */}
            <div className="flex flex-wrap md:flex-nowrap overflow-x-auto gap-3 mb-8 no-scrollbar">
              {categories.map((cat) => (
                <button
                  key={cat.id}
                  onClick={() => setActiveTab(cat.id)}
                  style={{ padding: '10px', borderRadius: "10px" }}
                  className={` text-sm font-medium transition-all duration-300 ${activeTab === cat.id
          ...
          >
            ...
            >
              ...
              <img
                ...
                style={{
                  transform: 'rotate(9deg) translateY(-79px);',
                  left:"60px",
                  borderRadius: "2rem",
                }}
              />
